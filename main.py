...
COLOR_PLAYER = (148, 0, 211)
COLOR_DISPLAY = (0, 191, 255)
COLOR_ENEMY = (255, 99, 71)
COLOR_BONUS = (0, 255, 0)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOR_ENEMY), (WIDTH-50, 20))
